...
git_repository(
    ...
    commit = "3cd4a85aeaedc3e23c7fb884ad0c2808fc1aa99d",
    shallow_since = "1627113356 +0200",
)
...
git_repository(
    ...
    commit = "bc86ae710628dde4d7485f0efa19feebe5154ab3",
    shallow_since = "1627152552 +0200",
)
