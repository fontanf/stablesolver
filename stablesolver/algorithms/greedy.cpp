...
Output stablesolver::greedy_gwmin(const Instance& instance, Info info)
{
...
Output stablesolver::greedy_gwmax(const Instance& instance, Info info)
{
...
Output stablesolver::greedy_gwmin2(const Instance& instance, Info info)
{
